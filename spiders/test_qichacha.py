...
"""
@author: xiaoke
@file: test_qichacha.py
@time:2020-04-07 13:56
@file_desc: 
"""
...
if __name__ == '__main__':
    ...
    tag.click()
    # 将用户名、密码注入
    driver.find_element_by_id('nameNormal').send_keys('18103714695')
    driver.find_element_by_id('pwdNormal').send_keys('13786140127')
